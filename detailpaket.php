...
<body>
  ...
  $ambilangka = array_rand($angka, 3); //pengambilan angka sebanyak 4 digit
  $angkastring = implode($ambilangka); //membuat angka-angka yang digenerate 
  $id = 'PSN-' . $tgl1 . $bln1 . $thn . $angkastring; //membuat kode dengan PSN + tgl, bln, thn + 4 kode acak di belakang
  ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select name="harga" id="harga_paket" onchange="price()" class="form-control" required>
                    <option value="">
                      <center>
                        <p style="text-align:center;">-- Pilih Hotel dan Jumlah Pax --</p>
                    </option>
                    <?php
                    ...
                    while ($data = mysqli_fetch_array($sql)) {
                      echo '<option value="' . $data['harga'] . '">' . $data['min'] . '-' . $data['max'] . '&nbsp; Peserta ' . $data['nama_hotel'] . '</option>';
                    }
                    ?>
                  </select>
  ...
  <div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane fade show active " id="nav-detail" role="tabpanel" aria-labelledby="nav-detail-tab">
      ...
      ?>
        <ul class="mt-5">
          <hr>
          <li>Nama Paket &nbsp; &nbsp;: &nbsp;<b> <?= $data['nama_paket'] ?></b></li>
          <hr>
          <li>Kategori &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;:&nbsp; <?= $data['nama_kategori'] ?></li>
          <hr>
          <li>Fasilitas &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;:&nbsp; <?= $data['fasilitas'] ?></li>
          <hr>
          <li>Disclaimer &nbsp; &nbsp;&nbsp; &nbsp;:&nbsp; <?= $data['disclaimer'] ?></li>
          <hr>
          <li>Destinasi &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; :&nbsp; <?= $data['nama_destinasi'] ?></li>
          <hr>
          <li>Lokasi &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; : &nbsp;<?= $data['lokasi_destinasi'] ?></li>
          <hr>
        </ul>
      <?php endwhile; ?>
