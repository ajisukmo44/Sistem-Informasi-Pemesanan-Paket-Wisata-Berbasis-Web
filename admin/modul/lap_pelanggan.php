...
?>
		...
		.tabel2 {
          ...
          <body>  
    <p align="center" style="font-size: 24px; float: center;"><b>DATA LAPORAN PELANGGAN</b></p>        
...
<P align="center"><img src="../../images/logo11.png" alt="logo" ></P>
        ...
        <thead style="text-align: center; background-color:#C1C1C1">
          ...
          <th style="text-align: center; background-color:#f5f5f5">Id PLG</th>
          <th style="text-align: center; background-color:#f5f5f5">Nama </th>
          <th style="text-align: center; background-color:#f5f5f5">Alamat</th>
          <th style="text-align: center; background-color:#f5f5f5">Email</th>
          <th style="text-align: center; background-color:#f5f5f5">No Hp</th>
        </tr>
		  </thead>
		  <tbody>
      ...
      if (mysqli_num_rows($result) > 0)
      {
        ...
        { 
          ...
          echo "<tr>
                  ...
                  <td style='text-align: center'>".$data['id_pelanggan']."</td>
