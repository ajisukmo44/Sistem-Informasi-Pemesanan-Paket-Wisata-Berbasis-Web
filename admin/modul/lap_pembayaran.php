...
<p align="center">Tanggal : <b><?= $tanggalawal1 ?></b>  sampai Tanggal : <b><?= $tanggalakhir1  ; ?></b></p>
        ...
        <thead style="text-align: center; background-color:#C1C1C1">
          ...
          <th style="text-align: center; background-color:#f5f5f5">Id pemesanan</th>
          <th style="text-align: center; background-color:#f5f5f5">Nama Pengirim</th>
          <th style="text-align: center; background-color:#f5f5f5">Rek Tujuan</th>
          <th style="text-align: center; background-color:#f5f5f5">Tgl Transfer</th>
          <th style="text-align: center; background-color:#f5f5f5">Jumlah Transfer</th>
        </tr>
		  </thead>
		  <tbody>
      ...
      $sql = "SELECT * FROM tabel_bayar a JOIN tabel_bank b ON a.norek_tujuan = b.no_rekening WHERE tanggal_transfer between '$tanggalawal' AND '$tanggalakhir'  AND a.status=2 ORDER BY id_pembayaran ASC";
