...
<?php include 'navbar.php'; ?>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <!-- DataTales Example -->
  <div class="card-body">
  <form action="modul/aksikategori/aksieditkategori.php" method="post">
  <div class="form-group row">
    <label for="id" class="col-sm-2 col-form-label">Id Kategori</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="id_kategori" id="id_kategori" value="<?php echo $data['id_kategori'] ?>" readonly>
    </div>
  </div>
  <div class="form-group row">
