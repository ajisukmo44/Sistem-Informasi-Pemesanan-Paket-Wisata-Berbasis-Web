...
$sql      = "SELECT * FROM tabel_hotel WHERE id_hotel = '$idhtl' ORDER BY id_hotel ASC";
...
<?php include 'navbar.php'; ?>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <!-- DataTales Example -->
  <div class="card-body">
  <form action="modul/aksihotel/aksiedithotel.php" method="post">
  <div class="form-group row">
    <label for="id" class="col-sm-3 col-form-label">Id Hotel</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" name="id_hotel" id="id_hotel" value="<?php echo $data['id_hotel'] ?>" readonly>
    </div>
    </div>
  
  <div class="form-group row">
    <label for="nama_hotel" class="col-sm-3 col-form-label">Nama Paket</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" name="nama_hotel" id="nama_hotel" value="<?php echo $data['nama_hotel'] ?>">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="bintang" class="col-sm-3 col-form-label">Bintang</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" name="bintang" id="bintang" value="<?php echo $data['bintang'] ?>">
    </div>
  </div>
