            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800"> <h3><a href="laporanpemesanan.php"> <i class="fas fa-file-invoice fa-2x mr-1 text-gray-300"></i></a> </h3></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800"><h3><a href="laporanpaket.php"> <i class="fas fa-file-invoice fa-2x mr-1 text-gray-300"></i></a> </h3></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-2 col-md-6 mb-4">
          <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Laporan Pelanggan</div>
