        ...
        <div class="col-xl-12 col-lg-8">
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Laporan Data Pembatalan
        
             </div>
             <?php
$sql 	= "SELECT * FROM tabel_pembatalan";
$data 	= mysqli_query($conn, $sql);
$tb = mysqli_num_rows($data);
?>
     <form action="modul/lap_pembatalan.php" method="post" enctype="multipart/form-data">
             <div class="form-group row mt-3 ml-3">
                  ...
                  <div class="col-sm-3">
                  Total Data Pembatalan<input type="text" class="form-control" name="total" id="total" value="<?php echo $tb ?>" readonly>
                  </div>
                  </div>
            <hr>
