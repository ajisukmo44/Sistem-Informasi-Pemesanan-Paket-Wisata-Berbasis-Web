...
<head>
  ...
  <title>Admin | Tambah Harga Paket</title>
        ...
        <div class="col-xl-8 col-lg-8">
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Harga </h6>
            ...
            <!-- Card Body -->
             ...
             <!-- DataTales Example -->
            <div class="card-body">
            <form action="modul/aksihargapaket/aksisimpanharga.php" method="post">

  <div class="form-group row">
    <label for="id_paket" class="col-sm-2 col-form-label">Nama Paket</label>
    <div class="col-sm-10">
